...
export default function PrivacyPolicyPage() {
	return (
		<main className="min-h-screen bg-dark text-white pt-32 pb-20">
			<div className="container mx-auto">
				...
				<div className="gradient-border p-8 rounded-2xl mb-12">
					<div className="prose prose-lg prose-invert max-w-none">
						<p className="text-gray-300">
							This Privacy Policy describes how your personal
							information is collected, used, and shared when you
							visit or make a purchase from justechlb.com (the
							"Site").
						</p>
						...
						<p className="text-gray-300">
							...
							your device. Additionally, as you browse the Site,
							we collect information about the individual web
							pages or products that you view, what websites or
							search terms referred you to the Site, and
							information about how you interact with the Site. We
						...
						<ul className="list-disc pl-6 mt-4 space-y-2 text-gray-300">
							<li>
								...
								device or computer and often include an
							...
							<li>
								...
								and collect data including your IP address,
						...
						<p className="text-gray-300">
							...
							invoices and/or order confirmations). Additionally,
						...
						<p className="text-gray-300 mt-4">
							...
							improve and optimize our Site (for example, by
							generating analytics about how our customers browse
							and interact with the Site, and to assess the
						...
						<p className="text-gray-300">
							...
							described above. For example, we use Google
							Analytics to help us understand how our customers
							use the Site--you can read more about how Google
						...
						<p className="text-gray-300 mt-4">
							...
							fulfill contracts we might have with you (for
							example if you make an order through the Site), or
							otherwise to pursue our legitimate business
							interests listed above. Additionally, please note
							that your information will be transferred outside of
						...
						<p className="text-gray-300">
							...
							info@justechlb.com or by mail using the details
							provided below:
						</p>

						<p className="text-gray-300 mt-4">
							123 Tech Street, Digital City, Lebanon, 12345
						</p>
					</div>
				</div>
				...
				<div className="text-center">
					<Link href="/">
						<Button className="bg-dark-lighter hover:bg-dark-light text-white border border-blue/20 rounded-full px-6">
